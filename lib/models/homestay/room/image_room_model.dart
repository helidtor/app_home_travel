...
class ImageRoomModel {
  ...
  factory ImageRoomModel.fromJson(String source) => ImageRoomModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'ImageRoomModel(id: $id, url: $url, roomId: $roomId, homeStayId: $homeStayId)';
  }
